...
{
    public class WithdrawCommandHandler : ICommandHandler<WithdrawCommand, Result<AccountResponse>>
    {
        private readonly IDatabaseContext _dbContext;
        private readonly IMapper _mapper;

        public WithdrawCommandHandler(IDatabaseContext dbContext, IMapper mapper)
        {
            _dbContext = dbContext;
            _mapper = mapper;
        }

        public async Task<Result<AccountResponse>> Handle(WithdrawCommand request, CancellationToken cancellationToken)
        {
            try
            {
